...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // SAKURA POSITIONING
  // ============================================
  const sakuras = document.querySelectorAll('.floating-sakura');
  
  sakuras.forEach((sakura, index) => {
    sakura.style.left = (10 + index * 20) + '%';
    sakura.style.setProperty('--left', (10 + index * 20) + '%');
  });
  
  const pixels = document.querySelectorAll('.floating-pixel');
  pixels.forEach((pixel, index) => {
    pixel.style.left = (20 + index * 30) + '%';
    pixel.style.top = (30 + index * 20) + '%';
  });
  ...
  // ============================================
  // MASCOT EYE TRACKING (follows mouse slightly)
  // ============================================
